...
export class CreateCompanyDto {
  ...
  @ApiPropertyOptional({ description: 'URL logo (signed URL có thể khá dài)' })
  @IsOptional()
  @IsString()
  logoUrl?: string;

  @ApiPropertyOptional({
    description: 'URL ảnh bìa (signed URL có thể khá dài)',
  })
  @IsOptional()
  @IsString()
  coverUrl?: string;
  ...
  @ApiPropertyOptional({
    enum: ['startup', 'tnhh', 'co_phan', 'fdi', 'tap_doan'],
  })
  @IsOptional()
  ...
  @IsEnum(['onsite', 'hybrid', 'remote'], {
    message: 'Mô hình làm việc không hợp lệ',
  })
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['13 tháng lương', 'Remote linh hoạt'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    example: 'https://linkedin.com/company/techvision-vn',
  })
  @IsOptional()
  @IsString()
  @MaxLength(500)
