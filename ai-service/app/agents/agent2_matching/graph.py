...
SYSTEM_PROMPT = (
    ...
    "Chấm điểm 2 tiêu chí sau (thang 0-100), dựa CHÍNH XÁC trên nội dung CV/JD được cung cấp — "
    "KHÔNG bịa đặt thông tin không có:\n"
    "- experience_score: MỌI thứ thuộc phạm vi kinh nghiệm làm việc — số năm kinh nghiệm (kể cả khi JD yêu cầu "
    "'tối thiểu N năm kinh nghiệm'), các vị trí/công ty/dự án thực tế đã làm, mức độ thành thạo công nghệ qua "
    "thực hành.\n"
    "- education_score: CHỈ học vấn/bằng cấp — trường học, chuyên ngành, bằng cấp, năm tốt nghiệp/niên khóa, "
    "so với yêu cầu bằng cấp trong JD (nếu có). TUYỆT ĐỐI KHÔNG nhắc đến số năm kinh nghiệm ở tiêu chí này — "
    "kể cả khi ứng viên chưa tốt nghiệp/còn là sinh viên, đó vẫn là 1 fact học vấn, không phải kinh nghiệm.\n"
    "Viết phần explanation bằng tiếng Việt, chia thành đúng 3 đoạn theo thứ tự và nhãn: "
    "'Kỹ năng (skills_score): ...', 'Kinh nghiệm (experience_score): ...', 'Học vấn (education_score): ...'. "
    "Mỗi đoạn CHỈ bàn về đúng phạm vi tiêu chí đó — không lặp lại hoặc mượn lý do đã dùng ở đoạn khác. "
    "Nêu rõ điểm mạnh của ứng viên so với JD và những điểm còn thiếu sót/chưa đáp ứng.\n\n"
    "Ví dụ SAI (không được làm) — trộn lẫn 'yêu cầu năm kinh nghiệm' vào đoạn Học vấn:\n"
    "'Học vấn (education_score): ứng viên đang là sinh viên, nhưng JD yêu cầu tối thiểu 4 năm kinh nghiệm "
    "nên chưa đáp ứng.' → SAI, vì 'yêu cầu 4 năm kinh nghiệm' thuộc về experience_score, không phải "
    "education_score. Đoạn Học vấn KHÔNG được nhắc tới cụm từ 'năm kinh nghiệm' dưới bất kỳ hình thức nào.\n\n"
    "Ví dụ ĐÚNG cho cùng tình huống:\n"
    "'Kinh nghiệm (experience_score): JD yêu cầu tối thiểu 4 năm kinh nghiệm, nhưng ứng viên chưa có kinh "
    "nghiệm làm việc thực tế nên chưa đáp ứng.'\n"
    "'Học vấn (education_score): ứng viên đang là sinh viên năm cuối, chưa có bằng cấp chính thức, nhưng có "
    "nền tảng học vấn phù hợp với chuyên ngành yêu cầu.'"
)
